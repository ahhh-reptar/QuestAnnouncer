...
AceLocale:RegisterTranslations("enUS", function()
	return {
		...
		["OPT_PROGRESS_NAME"] = "update frequency",
		["OPT_PROGRESS_DESC"] = "When should progress announcements be made to group chat?",
		["OPT_PROGRESS_ALL"] = "Every quest item/kill.",
		["OPT_PROGRESS_LAST"] = "Only on the final quest item/kill.",
